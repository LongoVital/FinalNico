...
class Materia extends Conexion
{
    ...
    public $id, $nombre_materia, $alumno_id;

    public function create()
    {
        $this->conectar();
        $pre = mysqli_prepare($this->con, "INSERT INTO materias (nombre_materia) VALUES (?)");
        $pre->bind_param("s", $this->nombre_materia);
        $pre->execute();
    } //CREO UNA MATERIA
    ...
    {
        $this->conectar();
        $pre = mysqli_prepare($this->con, "UPDATE materias SET nombre_materia = ? WHERE id = ?");
        $pre->bind_param("si", $this->nombre_materia, $this->id);
        $pre->execute();
    } //ACTUALIZO MATERIA
    ...
    public static function all() // devuelve todos los datos de la tabla materias
    {
        ...
        $conexion->conectar();
        $result = mysqli_prepare($conexion->con, "SELECT * FROM materias ORDER BY nombre_materia ASC");
        $result->execute();
