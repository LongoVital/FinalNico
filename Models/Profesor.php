...
class Profesor extends Conexion
{
    ...
    public function delete()
    {
        ...
        $pre = mysqli_prepare($this->con, "DELETE FROM profesores_materias WHERE profesores_id = ?");
    ...
    {
        $this->conectar();
        $result = mysqli_prepare($this->con, "SELECT materias.* FROM materias INNER JOIN profesores_materias ON materias.id = profesores_materias.materias_id WHERE profesores_materias.profesores_id = ?");
    ...
    {
        $this->conectar();
        $pre = mysqli_prepare($this->con, "INSERT INTO profesores_materias (profesores_id, materias_id) VALUES (?, ?)");
